...
"""
    View ejecuta estos metodos siguiendo el orden
...
#ListView hereda de View y es utilizado para listar
# Cuando usamos una vista basada en clases por defecto el resultado de la
# consultalo retorna como una lista de objetos.
